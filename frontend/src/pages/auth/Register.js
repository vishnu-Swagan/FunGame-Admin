      ...
      <form ref={formRef} onSubmit={submit} noValidate className="space-y-4">
        ...
        <Field label="Choose Login ID" htmlFor="reg-login-id" error={validationErrors.loginId}>
          ...
          {!validationErrors.loginId && (
            <p id="reg-login-id-help" className="text-[11px] leading-relaxed text-white/45">
              Start with a letter or number, then use 4–32 letters, numbers, dots, underscores, or hyphens.
            </p>
          )}
        </Field>
