...
const UPI_STATUS_COPY = {
  ...
  CREDITED: {
    ...
    detail: "The UPI payment was verified by our server and your wallet is updated.",
  },
  FAILED: {
    title: "UPI payment failed",
    detail: "SgPay did not confirm this payment. No chips were credited. You can try buying chips again.",
  },
  EXPIRED: {
    title: "UPI payment expired",
    detail: "The UPI checkout expired before payment was confirmed. No chips were credited. You can start a new purchase.",
  },
  REFUNDED: {
    title: "UPI payment refunded",
    detail: "The provider reports that this payment was refunded. Check Wallet activity or contact support if you need help with the balance.",
  },
  RECONCILIATION_REQUIRED: {
    title: "UPI payment needs review",
    detail: "The verified provider details did not match this deposit order. No chips were credited; support can review the reference safely.",
  },
};
...
const PAYMENT_STATUS_COPY = {
  CREATED: {
    ...
    detail: "Returning from checkout does not credit chips. Our server is checking the payment with the provider.",
  },
  PENDING: {
    title: "Payment being verified",
    detail: "Returning from checkout does not credit chips. Our server is checking the payment with the provider.",
  ...
  CREDITED: {
    title: "Chips credited",
    detail: "The provider payment was verified by our server and your wallet is updated.",
  },
  FAILED: {
    title: "Payment failed",
    detail: "The provider did not confirm this payment. No chips were credited. You can try buying chips again.",
  },
  EXPIRED: {
    title: "Payment expired",
    detail: "The checkout expired before payment was confirmed. No chips were credited. You can start a new purchase.",
  },
  REFUNDED: {
...
export default function DepositReturn() {
  ...
  const check = useCallback(async () => {
    ...
    setChecking(true);
    try {
      const result = await payments.refreshDeposit(depositId);
      setDeposit(result);
      setError("");
