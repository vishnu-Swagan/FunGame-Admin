...
export function normalizeAuthCapabilities(value) {
  ...
  if (manualReview) {
    ...
    return {
      ...
      player_login_verification_required: value?.player_login_verification_required === true,
      player_login_verification_available: value?.player_login_verification_available === true,
