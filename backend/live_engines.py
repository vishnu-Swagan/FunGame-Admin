...
from game_engines import (
    ...
    KENO_PAYTABLE, WHEEL_SEGMENTS, weighted_choice,
)
...
LIVE_GAMES = {
    ...
    "teen-patti":        {"bet": 14, "reveal": 5, "result": 6, "kind": "sides"},
    "poker":             {"bet": 14, "reveal": 5, "result": 6, "kind": "sides"},
    "no-hold":           {"bet": 13, "reveal": 4, "result": 3, "kind": "stake"},
    "champion-poker":    {"bet": 14, "reveal": 5, "result": 6, "kind": "stake"},
    "andar-bahar":       {"bet": 15, "reveal": 6, "result": 4, "kind": "sides"},
...
SLOT_SLUGS = {"fever-joker-bonus", "giant-jackpot", "joker-bonus", "lucky-8-line", "triple-fun"}
