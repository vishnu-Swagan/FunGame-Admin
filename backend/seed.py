...
GAMES = [
    ...
    {"slug": "chicken-road", "name": "Chicken Road", "category": "Crash", "tagline": "Hop the daylight lanes, cash out before traffic hits", "featured": True,
     "description": "Guide the chicken across a busy daylight street. Each manhole raises the multiplier - cash out your play chips before a vehicle hits it.",
     "art": {"from": "#6aa85a", "to": "#5a6570", "accent": "#3dcc6a", "icon": "bird", "glyph": "1.03x"}},
